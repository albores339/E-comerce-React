    ...
    return (
        <div className="shadow-lg bg-gradient-to-r from-cyan-100 cursor-pointer w-full h-56 rounded-lg my-6">
            <figure className="flex justify-center center relative mb-2 w-full h-3/4 bg-white">
                ...
                <div className="absolute top-0 right-0 flex justify-center items-center w-6 h-6 rounded-full m-2 bg-lime-500 bg-gradient-to-r from-lime-400 to-lime-500 hover:from-orange-400 hover:to-orange-500 text-white font-bold">+</div>
            </figure>
