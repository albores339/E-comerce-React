const Hero = () => {
    return (
        <div className="flex flex-col text-stone-700 md:flex-row lg:flex-row bg-stone-50 md:h-96">
        ...
        <p className="flex w-full md:w-11/12 flex-col text-center justify-center p-4">
          ...
          <button className=" bg-lime-400 w-3/5 text-white rounded-lg p-1 m-2">
          Buy Now
        </button>
          </div>
